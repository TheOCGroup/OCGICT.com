  ...
  return (
    <div className={`inline-flex flex-col select-none ${className}`}>
      <div className="flex items-center">
        <span
          className={`font-black font-sans leading-[0.85] text-transparent bg-clip-text bg-gradient-to-b from-[#161A22] via-[#1E2F57] to-[#2F6BFF] ${sizeClasses[size]}`}
          style={{
            letterSpacing: "-0.065em",
            fontWeight: 950,
            textShadow: "0 2px 18px rgba(37,99,235,0.22)",
          }}
        >
          OCG
        </span>
      ...
      <div
        className={`w-full rounded-full bg-gradient-to-r from-[#1D4ED8] via-[#2563EB] to-[#3B82F6] ${dividerClasses[size]}`}
        style={{ boxShadow: "0 0 10px rgba(37,99,235,0.28)" }}
      />
