...
| **Canonical Repository** | **SPECIFIED** | Target remote: `TheOCGroup/ocg-website` | Push git master to canonical remote when repository exists | GitHub repo creation permissions |

---

## 2. Summary of Immediate External Dependencies
1. **GitHub Canonical Remote**: Target `TheOCGroup/ocg-website` for git remote push.
